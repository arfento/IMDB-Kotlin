...
import com.ims.imdb_kotlin.adapters.HomePageAdapters
import com.ims.imdb_kotlin.databinding.FragmentHomeBinding
import com.ims.imdb_kotlin.listeners.BookMarkListener
import com.ims.imdb_kotlin.listeners.BookMarkListenerObject
import com.ims.imdb_kotlin.listeners.BookMarkStatusesListener
...
class HomeFragment : Fragment(), HomePageAdapters.onHomePageItemClickListener,
    ...
    private lateinit var nowPlayinAdapters: HomePageAdapters
    private lateinit var popularAdapters: HomePageAdapters
    ...
    open fun setUpObserver() {
        ...
        mViewModel.nowPlayingMutableLiveData.observe(viewLifecycleOwner){ results ->
            ...
            nowPlayinAdapters.notifyDataSetChanged()
    ...
    open fun initRootView() {
        ...
        binding.popularRecyclerview.layoutManager = l2
        nowPlayinAdapters = HomePageAdapters(nowPlayingList!!, requireContext(),this,0)
        popularAdapters = HomePageAdapters(popularList!!, requireContext(),this,0)
        binding.nowPlayingRecyclerview.adapter = nowPlayinAdapters
        binding.popularRecyclerview.adapter = popularAdapters
    ...
    override fun onItemChanged(result: Result?) {
        ...
        if (type == Keys.NOW_PLAYING) {
            ...
            if (i != -1) {
                ...
                nowPlayinAdapters.notifyItemChanged(i)
            }
        } else {
            ...
            if (i != -1) {
                ...
                res.bookmarked = !res.bookmarked
                popularList[i] = res
                popularAdapters.notifyItemChanged(i)
            }
        }
    }
