package com.ims.imdb_kotlin.ui.detail
...
import com.ims.imdb_kotlin.adapters.GenreAdapter
import com.ims.imdb_kotlin.models.Result
import com.ims.imdb_kotlin.databinding.FragmentDetailBinding
...
class DetailFragment : Fragment() {
    ...
    private fun bindView() {
        if (result != null){
            ...
            result.genre_ids?.let {
                Helper.getGenresFromIds(it)?.let {
                    genres!!.addAll(it) } }
        }
