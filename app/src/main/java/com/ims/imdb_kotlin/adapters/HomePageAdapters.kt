...
import com.ims.imdb_kotlin.databinding.BookMarkedItemBinding
import com.ims.imdb_kotlin.databinding.HomePageItemBinding
...
class HomePageAdapters(
    ...
    interface onHomePageItemClickListener {
        ...
        fun onBookMarkClicked(
            result: Result?, position: Int, listener: BookMarkListener?
        )
    }
